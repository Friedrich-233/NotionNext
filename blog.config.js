...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '证券公司上班有够无聊的, 闲的我找模版塔了个blog,没事更新的实习心得',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, HWB', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'friedrich.huang.233@gmail.com', // 邮箱地址 例如mail@tangly1024.com
